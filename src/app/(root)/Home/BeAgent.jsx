...
function BeAgent() {
    ...
    return (
        <>
            <section onClick={handleClick} id="agent" className="max-[768px]:cursor-pointer max-w-[1600px] mx-[auto] w-auto flex justify-center relative mt-7 max-[1025px]:mt-[60px] max-[431px]:mt-[20px] max-[431px]:mb-[5px] max-[1025px]:px-[20px] max-[431px]:px-[16px] max-[1400px]:mt-[100px] max-[1400px]:mb-[100px] px-[80px]">
