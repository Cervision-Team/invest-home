...
export default function Agents() {
  ...
  return (
    <section
      id="group"
      className="mt-[54px] max-w-[1600px] mx-auto w-auto flex flex-col gap-[80px] px-[80px] max-[1025px]:px-[20px] max-[431px]:px-[16px]"
    >
      ...
      <Suspense fallback={<AgentCardSkeleton />}>
        <div className="mb-[164px] grid grid-cols-4 grid-rows-1 max-[1025px]:grid-cols-2 max-[1025px]:grid-rows-2 max-[431px]:grid-cols-1 max-[431px]:grid-rows-1 gap-[20px]">
