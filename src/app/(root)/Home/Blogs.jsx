  ...
  return (
    <section className="max-[431px]:hidden [background:linear-gradient(180deg,_#02836F_0%,_#001D19_100%)]">
      <div className="max-w-[1600px] mx-auto">
        <div className="w-full mx-auto items-center pt-[83px] px-[80px] max-[1025px]:px-[20px] pb-[210px]">
          <p className="text-white text-[19.4px] font-medium tracking-[2.91px] uppercase text-center">
            Trenddə nədir ?
          </p>
          <h2 className="mb-[54px] text-white text-[39.8px]/[47px] font-semibold mt-[30px] text-center">
