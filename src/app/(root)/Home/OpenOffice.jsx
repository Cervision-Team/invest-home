      ...
      <div className='w-full h-auto px-[80px] '>
        <div className='md:flex-row  w-full h-auto px-[28px] py-[36px] flex flex-col items-center justify-start gap-[60px] relative '>
          ...
          <div className='max-w-[550px] flex flex-col justify-center items-start gap-[33px]'>
            ...
            <Link href="/open-office">
            <button className='w-[305px] h-[62px] bg-primary rounded-[30px] flex justify-center items-center cursor-pointer'>
        ...
        <svg className='absolute -top-3 -left-3' xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 54 54" fill="none">
       ...
       <svg className='absolute top-[46px] right-[300px]' xmlns="http://www.w3.org/2000/svg" width="61" height="61" viewBox="0 0 61 61" fill="none">
        ...
        <svg className='absolute right-0 bottom-[17px]' xmlns="http://www.w3.org/2000/svg" width="153" height="156" viewBox="0 0 153 156" fill="none">
        ...
        <svg className='absolute right-0 bottom-[65px]' xmlns="http://www.w3.org/2000/svg" width="66" height="66" viewBox="0 0 66 66" fill="none">
