...
const Hero = () => {
  return (
    <>
      <div className='w-full h-auto flex flex-col items-center justify-center px-4 sm:px-8 md:px-12 lg:px-20'>
        ...
        <div className='w-full flex flex-col lg:flex-row items-start justify-center gap-4 sm:gap-5 md:gap-6 mt-6 sm:mt-8 md:mt-9 mb-8 sm:mb-10 md:mb-13'>
            <Image 
              className='rounded-[20px] sm:rounded-[25px] md:rounded-[30px] w-full lg:w-auto' 
            ...
            <div className='flex flex-col gap-3 sm:gap-4 md:gap-5'>
              <h3 className='text-black text-xl sm:text-2xl md:text-[30px] leading-snug sm:leading-relaxed md:leading-[40px] font-medium'>
                Peşekarlar arasında öz yerinizi tutun!
              </h3>
              <h5 className='text-[#3F444D] text-sm sm:text-base md:text-[18px] leading-relaxed sm:leading-7 md:leading-[28px]'>
       ...
       <a href="#office-form" className='w-full flex justify-center items-center'>
        <button className='w-full sm:w-[250px] md:w-[220px] h-12 sm:h-[50px] flex justify-center items-center rounded-lg bg-primary hover:opacity-90 transition-opacity'>
          <span className='text-white text-center text-sm sm:text-base md:text-[16px] leading-6 md:leading-[24px] font-medium'>
            Forma kliklə
          </span>
        </button>
       </a>
