                    ...
                    data.map((_, i) => (
                        <div className='rounded-[20px] shadow-[0px_4px_10px_0px_#00000026] p-5'>
                            ...
                            <div className='flex flex-col gap-2 mt-3'>
                                <button className='cursor-pointer bg-green-200 py-2 rounded-sm'>Tesdiq et</button>
                                <button className='cursor-pointer bg-red-200 py-2 rounded-sm'>Redd et</button>
                            </div>
